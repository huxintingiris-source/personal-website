...
export const UsageGuide = () => {
  return (
    <section className="bg-white dark:bg-black/40 backdrop-blur-md rounded-2xl p-6 shadow-[0_2px_15px_rgba(0,0,0,0.03)] border border-slate-100 dark:border-zinc-800 mt-8">
